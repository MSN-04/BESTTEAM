      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-700 d-flex ftco-animate">
              ...
              <a href="../blog/blog-single.jsp" class="block-20" style="background-image: url('../images/image_1.jpg');">
              </a>
                <h2 class="heading mt-2"><a href="#">카페라떼를 여행하는 히치하이커를 위한 안내서</a></h2>
...
<!--                   <div><a href="#">관리자</a></div> -->
                ...
                <p>커피의 맛이 가장 강렬하게 살아난 순간 로스팅을 멈추고 향을 놓치지 않는, 원두의 맛이 가장
								훌륭한 그 포인트를 잡아내기 위해 최선을 다 합니다.</p>
              </div>
            </div>
          </div>
          <div class="col-md-700 d-flex ftco-animate">
              ...
              <div class="text py-4 d-block">
                ...
                <h3 class="heading mt-2"><a href="#">카페라떼를 여행하는 히치하이커를 위한 안내서</a></h3>
                <div class="meta">
                  <div><a href="#">Sept 28</a></div>
<!--                   <div><a href="#">관리자</a></div> -->
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
