              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="firstname">주민 등록 번호</label> <input type="text"
                    class="form-control" placeholder="6자리 입력하세요" name="jumin1" required="required" maxlength="6" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                   <input type="password" class="form-control" placeholder="7자리 입력하세요"
                    name="jumin2" required="required" maxlength="7" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                </div>
              </div>
              <div class="w-100"></div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="postcodezip">우편번호</label> <input type="text"
                    class="form-control" id="postcode" placeholder="우편번호를 검색해주세요"
                    required="required" name="post" readonly="readonly">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
