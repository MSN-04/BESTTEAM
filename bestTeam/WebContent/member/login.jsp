        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><div class="container">
	<div id="content">    
		<div class="post">    	
        	<div class="btn-sign">				
...
</div></span> <span><a href="../member/join.jsp">회원가입</a></span></p>
            </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 ftco-animate">
	             ...
	             <a href="../index/index.html" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3 join">회원가입</a>
									</div>
                </div>
	            </div>
