		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 ftco-animate" style="margin: auto;">
					<form action="update_member_pro.jsp" class="billing-form ftco-bg-dark p-3 p-md-5">
						<h3 class="mb-4 billing-heading">회원 정보</h3>
						<div class="row align-items-end">
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">아이디</label> <p>slamzz</p>
								</div>
							</div>
							<div class="w-100"></div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">이름</label> <p>이기홍</p>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="firstname">나이</label> <p>27</p>
								</div>
							</div>
							<div class="w-100"></div>
							<div class="col-md-6">
...
<!-- 							</div> -->
                ...
                <div class="col-md-12">
                	<div class="form-group mt-4">
										<a href="#login-box"
					class="login-window  btn btn-primary p-3 px-xl-4 py-xl-3">정보 수정</a>
										 <div id="login-box" class="login-popup"
			style="width: 300px; height: 300px;">
			<a href="#" class="close"><img src="../images/close_pop.png"
				class="btn_close" title="Close Window" alt="Close" /></a>
			<form method="post" class="signin" action="#login-box">
				<fieldset class="textbox">
					<label class="username"> <span>ID</span> <input
						id="username" name="username" value="" type="text"
						autocomplete="on" placeholder="slamzz">
					</label> <label class="password"> <span>Password</span> <input
						id="password" name="password" value="" type="password"
						placeholder="Password">
					</label>
					<button class="login-window nav-link btn btn-primary p-3 px-xl-4 py-xl-3" type="submit">정보 수정</button>
				</fieldset>
			</form>
			
		</div>
										 <a href="delete_member.jsp" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">회원 탈퇴</a>
									</div>
                </div>
	            </div>
	          </form><!-- END -->
