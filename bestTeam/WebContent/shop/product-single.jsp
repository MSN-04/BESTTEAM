			...
			<div class="container">
				<div
					...
					<div class="col-md-7 col-sm-12 text-center ftco-animate">
						...
						<p class="breadcrumbs">
							<span class="mr-2"><a href="index.in">Home</a></span> <span>Product
								Detail</span>
						</p>
					</div>
			...
			<div class="row">
				...
				<div class="container1">
					<span id="sd"><img
						...
						style="width: 500px; height: 500px;"></span>
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<div class="col-md-12 mb-3">
						...
						<div class="tagcloud">
							<a href="" class="tag-cloud-link">AROMA : <%=itemBean.getItem_favor_aroma()%></a>
							<a href="" class="tag-cloud-link">ACIDITY : <%=itemBean.getItem_favor_acidity()%></a>
							<a href="" class="tag-cloud-link">SWEETNESS : <%=itemBean.getItem_favor_sweetness()%></a><br>
							<a href="" class="tag-cloud-link">BITTERNESS : <%=itemBean.getItem_favor_bitterness()%></a>
							<a href="" class="tag-cloud-link">BODY : <%=itemBean.getItem_favor_body()%></a>
						</div>
					...
					<div class="row mt-4">
						...
						<div class="input-group col-md-6 d-flex mb-3">
							...
							<div class="input-group mb-3">
								...
								<form action="cartPro.em" method="post" id="frm" name="frm">
<%-- 									<input type="hidden" name="user_id" value=<%=sessionId%>> --%>
									...
									<input type="hidden" name="item_num" value=<%=itemBean.getItem_num()%>> 
									<input type="hidden" name="item_price" value=<%=itemBean.getItem_price()%>> 
									<input type="submit" value="Add to Cart" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3 cart" >
								...
								<div class="row1">
									...
									<div class="row1">
										<div class="column">
											<img class="demo cursor" id="im" src="./images/tt.jpg"
												onclick="currentSlide(1)" alt="">
										</div>
										<div class="column">
											<img class="demo cursor" id="im" src="./images/tt3.jpg"
												onclick="currentSlide(2)" alt="">
										</div>
										<div class="column">
											<img class="demo cursor" id="im" src="./images/tt4.jpg"
												onclick="currentSlide(3)" alt="">
										</div>
										<div class="column">
											<img class="demo cursor" id="im" src="./images/tt5.jpg"
	...
	<section class="ftco-menu mb-5 pb-5">
		...
		<div class="nav ftco-animate nav-pills justify-content-center"
			...
			<a class="nav-link active" data-toggle="pill" href="#v-pills-0"
				role="tab" aria-controls="v-pills-0" id="btn1" aria-selected="true"
				style="width: 200px; text-align: center;">상세정보</a> <a
				class="nav-link" data-toggle="pill" href="#v-pills-1" id="btn2"
				role="tab" aria-controls="v-pills-1" aria-selected="false"
				style="width: 200px; text-align: center;">상품후기</a> <a
				class="nav-link" data-toggle="pill" href="#v-pills-2" id="btn3"
				role="tab" aria-controls="v-pills-2" aria-selected="false"
				style="width: 200px; text-align: center;">상품Q&A</a>
			...
			%>
			<a class="nav-link"
				href="itemModify.em?item_num=<%=itemBean.getItem_num()%>" id="btn4"
				role="tab" aria-controls="v-pills-2" aria-selected="false"
				style="width: 200px; text-align: center; color: white !important;">상품정보
				수정</a> <a class="nav-link"
				href="itemDeletePro.em?item_num=<%=itemBean.getItem_num()%>"
				id="btn4" role="tab" aria-controls="v-pills-2" aria-selected="false"
				style="width: 200px; text-align: center; color: white !important;">상품정보
				삭제</a>
			<%
				}
		...
		<div class="row rows">
			<div class="col-md-12 ftco-animate">
				...
				<table class="table">
					<tr>
						<td><class="img11">
							<img src="./itemUpload/<%=itemBean.getItem_content()%>"></td>
					</tr>
			...
			<div class="row d-flex">
				<div class="blog-entry align-self-stretch">
					...
					<table class="table thead-light">
						...
						<tr>
							<td>2</td>
							<td><a href="#"><img alt="key" src="./images/zzzz.png"
									id="imim">상품 관련 문의입니다.</a></td>
							<td>19.04.23</td>
							<td>admin</td>
							<td>3</td>
						</tr>
