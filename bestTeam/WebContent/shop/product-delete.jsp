        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
            	<h1 class="mb-3 mt-5 bread">상품 삭제하기</h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 ftco-animate" style="margin: auto;">
					<form action="itemDeletePro.em?item_num=<%=item_num %>&item_favor_num=<%=item_favor_num %>" method="post" class="billing-form ftco-bg-dark p-3 p-md-5" id="del">
						<h3 class="mb-4 billing-heading">상품 삭제하기</h3>
