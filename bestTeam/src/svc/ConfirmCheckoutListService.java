...
//		System.out.println("ConfirmCheckoutListService-- user_id:"+user_id);
		...
		buyList=buydao.selectConfirmCheckoutList(user_id, page, limit);
	...
	// ---> 글 목록 개수 구하기
	public int getBuyListCount(String id) throws Exception{
		int buyListCount=0;
		...
		buyListCount=buyDAO.selectBuyListCount(id);
