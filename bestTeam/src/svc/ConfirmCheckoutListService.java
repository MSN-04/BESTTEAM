...
public class ConfirmCheckoutListService {
	...
	//상품 목록 조회
	public ArrayList<BuyBean> selectConfirmCheckoutList(int buy_num,String user_id) throws Exception{
		...
		articleList=buydao.selectConfirmCheckoutList(user_id, buy_num);
		close(con);
