...
<!--     				<div  style="background-size: cover; background-repeat: no-repeat; background-image: url(../images/moon.jpg); width: 80px; height: 80px; margin-bottom: 10px; "></div> -->
    				...
    				<div>
	    				<p style="font-weight: bold;margin-bottom: 1px;line-height: 10px;">Tinkervell</p>
	    				<p>May 14</p>
    				</div>
    			</li>
          ...
          <div class="col-md-8 ftco-animate" >
            ...
            <div class="col-md-12">
                <div class="form-group mt-4">
                  <a href="login.jsp"
                    class="btn btn-primary p-3 px-xl-4 py-xl-3">이전글</a> <a href="login.jsp"
                    class="btn btn-primary p-3 px-xl-4 py-xl-3">다음글</a>
                    </div>
                </div>
