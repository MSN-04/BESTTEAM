...
<div class="container1">
	<img src="tt.jpg" style="width:500px; height: 500px;" id="sd">
  ...
  <div class="mySlides">
    <div class="numbertext"></div>
      <img src="tt3.jpg" style="width:500px; height: 500px;" id="sd">
  </div>

  <div class="mySlides">
    <div class="numbertext"></div>
      <img src="tt4.jpg" style="width:500px; height: 500px;" id="sd">
  </div>

  <div class="mySlides">
    <div class="numbertext"></div>
      <img src="tt5.jpg" style="width:500px; height: 500px;" id="sd">
  </div>
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>
						<a href="cart.jsp" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3 cart">Add to Cart</a><a href="cart.html"
							...
							<div class="row1">
    <div class="column">
      <img class="demo cursor" src="tt.jpg" style="width: 70px; height: 70px;" onclick="currentSlide(1)" alt="">
    </div>
    <div class="column"> 
      <img class="demo cursor" src="tt3.jpg" style="width: 70px; height: 70px;" onclick="currentSlide(2)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="tt4.jpg" style="width: 70px; height: 70px;" onclick="currentSlide(3)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="tt5.jpg" style="width: 70px; height: 70px;" onclick="currentSlide(4)" alt="">
    </div>
...
<section class="ftco-menu mb-5 pb-5" >
	...
	<section class="ftco-section" 
		id="ft1" style="margin-top: -100px;">
		<div class="row rows" >
			<div class="col-md-12 ftco-animate">
					
					<table class="table">
						<tr>
							<td><img src="tt1.jpg"  class="img11"></td>
						</tr>
	...
	<section class="ftco=section" id="ft2" style="margin-top: -100px;">
		<div class="container">
	...
	<section class="ftco=section" id="ft3" style="margin-top: -100px;">
		<div class="container">
			<div class="row d-flex">
				<div class="blog-entry align-self-stretch">
					<br>
					...
					<tr>Q & A</tr>
						...
						<tr>
							<td>2</td>
							<td><a href="#"><img alt="key" src="zzzzz.png" style="width: 22px; height: 22px; ">상품 관련 문의입니다.</a></td>
							<td>19.04.23</td>
							<td>admin</td>
							<td>3</td>
						</tr>
