...
<!-- 		            </div> -->
		        ...
		        <div class="col-md-6">
		        	<div class="form-group">
	               		...
	               		<input type="text" class="form-control" id="postcode" placeholder="우편번호"  required="required">
	              	</div>
	           	</div>
			...
			<!-- /우편번호 검색 API -->
	            ...
	            <div class="col-md-6">
	            	<div class="form-group">
                  		<input type="text" class="form-control" id="detailAddress" placeholder="상세주소"  required="required">
                	</div>
	            </div>
							...
							function checkout() {
								...
								if(a){
									...
									IMP.request_pay({ // (1) param : 결제요청에 필요한 정보를 담는 객체
									    ...
									    merchant_uid: "20190430-A01",	// * 주문번호, (필수항목) 결제가 된 적이 있는 merchant_uid로는 재결제 불가
									    name: "원두",	// 주문명
									    amount: 100,	// 결제 금액
